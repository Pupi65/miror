...
if len(GD_INFO) == 0:
    GD_INFO = 'Uploaded by Hiyabo Mirror Bot'
...
if len(UPSTREAM_REPO) == 0:
   UPSTREAM_REPO = 'https://github.com/hiyabo69/wzml-railway'
